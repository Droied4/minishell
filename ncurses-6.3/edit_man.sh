...
TERMINFO="/Users/avolcy/local/share/terminfo"
...
(*.[0-9]*)
	...
	if test ! -f "/Users/avolcy/Cursus42/minishell/ncurses-6.3/man_alias.sed" ; then
cat >>/Users/avolcy/Cursus42/minishell/ncurses-6.3/man_alias.sed <<-CF_EOF2
		s,@DATADIR@,$datadir,g
...
s,@TSET@,tset,g
CF_EOF2
		echo "...made /Users/avolcy/Cursus42/minishell/ncurses-6.3/man_alias.sed"
	fi
	...
	aliases=`sed -f "$top_srcdir/man/manlinks.sed" "$inalias" |sed -f "/Users/avolcy/Cursus42/minishell/ncurses-6.3/man_alias.sed" | sort -u; test "$inalias" = "$nCurses" && echo curses`
	...
	sed	-f "/Users/avolcy/Cursus42/minishell/ncurses-6.3/man_alias.sed" \
		< "$i" >$TMP
